...
event_rec_object_facet = uco.observable.EventRecordFacet(
    ...
    event_record_raw="[CDATA[Wifi In:0, Wifi Out:0, Wan In:37847, 10689999, Wan Out:18956]]",
    event_record_service_name="BeReal",
    event_record_text="Wifi In:0, Wifi Out:0, Wan In:37847, 10689999, Wan Out:18956",
    event_type="information",
